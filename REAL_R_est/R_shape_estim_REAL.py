...
def R_estimator_VdW_score(y, mu, S0, pert):
    ...
    # Input:
    #   y: (N, K)-dim data array where N is the dimension of each vector and K is the number of available data
...
def kernel_rank_sign(y,S0):
    ...
    return kernel_vect, u
    
def  Delta_Psi_eval(y, S, M_n):
    N, K = y.shape

    kernel_vect, u = kernel_rank_sign(y,S)
